...
const NewPostForm = ({
  ...
  const [btnValue, setBtnValue] = useState(editSnippet ? "Editer mon snippet" : "Partager mon code au monde ! 🚀")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setBtnValue(editSnippet ? "Editer mon snippet" : "Partager mon code au monde ! 🚀");
