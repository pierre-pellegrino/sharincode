    ...
    {`
      ...
      *::after {
      ...
      :root {
        ...
        --primary: ${
          highlights.switchColors ? highlights.keyword : highlights.def
        };
        --secondary: ${
          highlights.switchColors ? highlights.def : highlights.keyword
        };
      }
      ...
      .bg-global-secondary {
        ...
        --shadow-medium: 0.3px 0.5px 0.7px
          ...
          0.8px 1.6px 2px -0.8px hsl(${
            highlights.shadow ?? highlights.background2
          } / 0.36),
          2.1px 4.1px 5.2px -1.7px hsl(${
            highlights.shadow ?? highlights.background2
          } / 0.36),
          5px 10px 12.6px -2.5px hsl(${
            highlights.shadow ?? highlights.background2
          } / 0.36);

        --shadow-low: 0.3px 0.5px 0.7px
            hsl(${highlights.shadow ?? highlights.background2} / 0.34),
          0.4px 0.8px 1px -1.2px hsl(${
            highlights.shadow ?? highlights.background2
          } / 0.34),
          1px 2px 2.5px -2.5px hsl(${
            highlights.shadow ?? highlights.background2
          } / 0.34);
